...
mod tests {
    ...
    fn single_image_does_not_trip_default_handoff_threshold() {
        ...
        // defaults (max_context_tokens=200_000, max_output_tokens=65_536) is
        // min(200_000*9/10, 200_000-65_536) = 134_464 "bytes". Before the fix
        // this item counted ~3.1M and tripped instantly.
        let item = image_item(3_118_884);
        const DEFAULT_PRE_USAGE_THRESHOLD: usize = 134_464;
        assert!(

...
import {
  hasQueuedDraftAttachments,
  isBackgroundMediaUploadInFlight,
...
/** Idle read, normalized to ms. Unknown/unsupported/errored → null (never fire). */
async function readOsIdleMs(): Promise<number | null> {
  try {

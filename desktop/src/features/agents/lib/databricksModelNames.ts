...
// Refresh: python3 scripts/generate-databricks-model-names.py (then port to TS)
//
 ...
 */
export const DATABRICKS_MODEL_NAMES: Record<string, string> = {
 ...
 * ID when no entry exists in the registry. No heuristic guessing.
 */
export function databricksModelName(id: string): string {
  return DATABRICKS_MODEL_NAMES[id] ?? id;
}

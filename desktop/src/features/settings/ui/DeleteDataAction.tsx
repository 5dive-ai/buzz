...
/** Props for a destructive data-deletion entry point. */
type DeleteDataActionProps = {
  className?: string;
  label?: string;
  pendingLabel?: string;
  testId?: string;
...
/**
 * Opens the shared destructive data-deletion flow.
 *
 * Keep every entry point wired to this component so onboarding and Settings
 * retain the same recovery and typed-confirmation gates.
 */
export function DeleteDataAction({
  className,
  label = "Delete my data",
  pendingLabel = "Signing out…",
  testId = "signout-open-dialog",
  variant = "destructive",
}: DeleteDataActionProps) {

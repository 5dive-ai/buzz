/**
 * Appearance settings panel: theme selection (paired/single tiles), accent
 * color picker, link-preview style, and thread layout. Extracted from
 * SettingsPanels.tsx to keep that file under the size ratchet.
 */
